...
AirNow-I project. If available, the configuration is published by the scs_dev/status_sampler utility.

For remote configuration, the airnow_site_conf utility should be made accessible via the
